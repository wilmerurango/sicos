...
# apis
from solicitud.api import UserAPI
...
urlpatterns = [
    ...
    path('solicitudes/', login_required(base_solicitud), name='base_solicitud'),
    ...
    #CIRUGIA=============================================================================================================
    path('Reporte_salario_excel/',Reporte_salario_excel.as_view(), name ='Reporte_salario_excel'),
    ...
    path('report_proc_excel/',Reporte_Proc_excel.as_view(), name ='Reporte_proc_excel'),
    path('Reporte_Canasta_excel/',Reporte_Canasta_excel.as_view(), name ='Reporte_Canasta_excel'),
    ...
    path('editarfactesp/<int:pk>/', login_required(fac_especialistaEdit.as_view()), name='fac_especialista_edit'),
    ...
    path('editarfacdetal/<int:id_>/', login_required(fac_especialista_detalleEdit), name='fac_especialista_detalle_edit'),
    path('eliminarfacdetal/<int:id_>/', login_required(fac_especialista_detalle_elim), name='eliminarfacdetal'),
