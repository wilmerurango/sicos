...
class calculo():
    ...
    def resultado(self):
            ...
            if i.concepto_honorario.nombre_concep_hon=="ISS PLENO":
                ...
                if i.concepto_honorario.nombre_concep_hon=="ISS + 10%":
                    ...
                    if i.concepto_honorario.nombre_concep_hon=="SOAT - 20%":
                        ...
                        if i.concepto_honorario.nombre_concep_hon=="SOAT - 10%":
                            i.costo = round(i.costo*self.obj9.last().smdlv*0.9*(1+consul_ultimo.ganancia/100))
                            if i.costo >= maximo:
                                maximo= i.costo
                        else:
                            if i.concepto_honorario.nombre_concep_hon=="SOAT":
                                i.costo = round(i.costo*self.obj9.last().smdlv*(1+consul_ultimo.ganancia/100))
                                if i.costo >= maximo:
                                    maximo= i.costo
                            else:
        ...
        datos_obte.append(canasta.order_by('concepto_canasta'))
